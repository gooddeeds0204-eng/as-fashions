/**
 * AS FASHIONS — Offers & Promotions Engine
 */
(function (global) {
  'use strict';
  ...
  function getCoupons() {
    try {
      ...
      return SEEDED_COUPONS.concat(activeAdmin);
    } catch (e) { return SEEDED_COUPONS; }
  }
  ...
  function getPromoBanners() {
    try {
      ...
      return activeAdmin.length ? activeAdmin : SEEDED_BANNERS;
    } catch (e) { return SEEDED_BANNERS; }
  }
